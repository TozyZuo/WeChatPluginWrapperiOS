...
@class MMServiceCenter; @class SettingUtil; @class MMNewSessionMgr; @class CMessageMgr; @class CVerifyContactWrap; @class AutoSetRemarkMgr; @class CMessageWrap; @class FriendAsistSessionMgr; @class CContactVerifyLogic; @class SayHelloDataLogic; @class WCDeviceStepObject; 
